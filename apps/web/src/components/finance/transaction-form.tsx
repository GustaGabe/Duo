        ...
        <div className="flex min-w-0 flex-1 flex-col gap-5">
          ...
          <div className="flex gap-3">
            <Field
              label="Categoria"
              className="flex-1"
              hint={options.length === 0 ? 'Crie uma categoria para lançar.' : undefined}
            >
              {(id) => (
                <div className="flex gap-2">
                  {options.length === 0 ? (
                    <button
                      ...
                      className="h-14 min-w-0 flex-1 cursor-pointer rounded-field border-[1.5px] border-dashed border-line-dashed px-4 text-left text-body text-accent transition-colors hover:bg-surface-2 lg:h-13"
                    >
                  ...
                  <button
                    ...
                    onClick={() => setCreatingCategory(true)}
                    className="grid size-14 shrink-0 cursor-pointer place-items-center rounded-field border-[1.5px] border-line bg-surface text-xl text-ink transition-colors hover:bg-surface-2 lg:size-13"
                  >
                    +
                  </button>
                </div>
